class TradePlanChart {
  ...
  setData(options){Object.assign(this,options);this.container.classList.toggle('without-spot-plan',!this.showPlan);this.chart.applyOptions({timeScale:{timeVisible:['1m','3m','5m','15m','1h'].includes(this.timeframe),tickMarkFormatter:time=>this.formatTime(time)}});this.series.setData(this.candles);this.chart.timeScale().fitContent();this.renderOverlay()}
  updateOverlay(){
