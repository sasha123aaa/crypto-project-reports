...
export async function buildReport(project){
  ...
  return {
    ...
    market:{
      ...
      max_supply: metric(maxSupply, maxSupply!=null?maxSupply.toLocaleString("ru-RU"):"Нет", maxSupply!=null?STATUS.LIVE:STATUS.STATIC, maxSupply!=null?"CoinGecko":"project structure"),
    },
