...
export function calcAnnualizedFeesToMarketCap(fees24h,marketCap){ const ratio=safeDivide(fees24h==null?null:fees24h*365,marketCap); return ratio==null?null:ratio*100; }
